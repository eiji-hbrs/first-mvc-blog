...
-- -----------------------------------------------------
-- Table `first-eiji`.`category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `first-eiji`.`category` ;

CREATE TABLE IF NOT EXISTS `first-eiji`.`category` (
...
-- -----------------------------------------------------
-- Table `first-eiji`.`article_has_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `first-eiji`.`article_has_category` ;

CREATE TABLE IF NOT EXISTS `first-eiji`.`article_has_category` (
  `article_id` INT NOT NULL,
  `category_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`article_id`, `category_id`),
  CONSTRAINT `fk_article_has_category_article1`
    FOREIGN KEY (`article_id`)
    REFERENCES `first-eiji`.`article` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_article_has_category_category1`
    FOREIGN KEY (`category_id`)
    REFERENCES `first-eiji`.`category` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;

CREATE INDEX `fk_article_has_category_category1_idx` ON `first-eiji`.`article_has_category` (`category_id` ASC) VISIBLE;

CREATE INDEX `fk_article_has_category_article1_idx` ON `first-eiji`.`article_has_category` (`article_id` ASC) VISIBLE;
